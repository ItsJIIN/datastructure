...
void printHospitalsInCity(struct Hospital hospitals[])
{
    ...
    printf("Enter city name (Dhaka, Chittagong, or other): ");
    scanf("%s", city);
...
int main()
{
    ...
    struct Hospital hospitals[5]= {
        {"Dhaka Medical College Hospital", "Dhaka", 1000, 2000, 4.5, 500},
    {"Apollo Hospitals Dhaka", "Dhaka", 500, 4500, 4.8, 800},
    {"Chittagong Medical College Hospital", "Chittagong", 800, 1500, 4.0, 300},
    {"Square Hospitals Ltd.", "Dhaka", 300, 3000, 4.7, 600},
    {"Bangabandhu Sheikh Mujib Medical University", "Dhaka", 600, 2500, 4.6, 700}
    };
    ...
    do
    {
        ...
        printf("2.  Patients Data\n");
        printf("3. List of Hospitals by Beds Price\n");
        printf("4. List of Hospitals by Available Beds\n");
        printf("5. List of Hospitals by Name\n");
        printf("6. List of Hospitals by Rating and Reviews\n");
        printf("7. Hospitals in a Specific City\n");
        printf("8. Exit\n\n");
        ...
        case 2:
            ...
            break;
        case 3:
            printf("List of Hospitals by Beds Price "
                   "(Ascending):\n");
            ...
            break;
        case 4:
            printf("List of Hospitals by Available Beds "
                   "(Descending):\n");
        ...
        case 5:
            printf(
                "List of Hospitals by Name (Ascending):\n");
            ...
            break;
        case 6:
            printf("List of Hospitals by Rating and "
                   "Reviews (Descending):\n");
